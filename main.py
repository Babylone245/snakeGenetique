...
nn = genetic.optimize(taillePopulation=400, tailleSelection=50, pc=0.8, arch=[nbFeatures, 24, nbActions], gameParams=gameParams, nbIterations=400, nbThreads=10, scoreMax=1.0, mr = 2.0)
